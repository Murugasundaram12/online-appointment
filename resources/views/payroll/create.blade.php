    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
            <div class="d-flex align-items-center">
                <h2 class="fs-4 m-0 fw-bold">Create Payroll Record</h2>
            </div>
        </nav>
                ...
                <form action="{{ route('payroll.store') }}" method="POST" id="payrollForm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="total_hours" name="total_hours"
                                ...
                                value="{{ old('total_hours', 0) }}" step="0.5" min="0">
                            @error('total_hours')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="commission_amount" name="commission_amount"
                                ...
                                value="{{ old('commission_amount', 0) }}" step="0.01" min="0" onchange="calculateTotal()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="bonus" name="bonus"
                                class="form-control @error('bonus') is-invalid @enderror" value="{{ old('bonus', 0) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="deductions" name="deductions"
                                ...
                                value="{{ old('deductions', 0) }}" step="0.01" min="0" onchange="calculateTotal()">
                            @error('deductions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="payment_type" name="payment_type"
                                ...
                                <option value="transfer" {{ old('payment_type') == 'transfer' ? 'selected' : '' }}>Bank
                                    Transfer</option>
                    ...
                    <div class="summary-box">
                        ...
                        <div class="summary-row">
                            ...
                            <span class="summary-value" id="display-salary">0.00</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Commission</span>
                            <span class="summary-value" id="display-commission">0.00</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Bonus</span>
                            <span class="summary-value" id="display-bonus">0.00</span>
                        </div>
                        <div class="summary-row">
                            <span class="summary-label">Deductions</span>
                            <span class="summary-value" id="display-deductions">0.00</span>
                        </div>
                        <div class="summary-row"
                            ...
                            <span class="total-payout" id="display-total">0.00</span>
                        </div>
                    </div>

                    {{-- Actions --}}
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-submit">Create Payroll</button>
