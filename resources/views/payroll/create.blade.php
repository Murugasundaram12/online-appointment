...
@section('content')
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="fs-3 fw-bold mb-1">Create Payroll</h1>
                <p class="text-muted mb-0">Create a salary record with commission, bonus, and deductions.</p>
            </div>
    ...
    <script>
        ...
        document.getElementById('staff_id').addEventListener('change', event => {
            ...
            if (option && option.dataset.salary && !parseFloat(document.getElementById('salary_amount').value)) {
                document.getElementById('salary_amount').value = parseFloat(option.dataset.salary).toFixed(2);
                calculateTotal();
            }
        });
