    ...
    <div class="container-fluid px-4 pt-4">
        <div class="card shadow-sm border-0 rounded">
            <div class="card-body p-4">
                <form action="{{ route('packages.store') }}" method="POST" novalidate>
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            @enderror
                            <input type="number" class="form-control @error('validity_days') is-invalid @enderror" id="validity_days" name="validity_days" value="{{ old('validity_days') }}">
                        </div>
                        <div class="col-12">
                            ...
                            <div class="border rounded p-3" style="max-height: 200px; overflow-y: auto;">
                                @forelse($services as $service)
                                    <div class="d-flex align-items-center gap-3 mb-2">
                                        ...
                                        <input type="number" class="form-control" name="services[{{ $service->id }}][quantity]" value="1" min="1" style="width:90px">
                                    </div>
                                @empty
